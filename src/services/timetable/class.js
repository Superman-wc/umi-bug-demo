...
export async function list(data) {
  return request('/api/8queen/lecture/klass', {data, method: 'GET'});
}

export async function modify(data) {
  return request('/api/8queen/lecture/klass/' + data.id + '/op/substitute', {data, method: 'PUT'});
}

export async function create(data) {
  return request('/api/8queen/lecture/klass', {data, method: 'POST'});
}

export async function remove({id}) {
  return request('/api/8queen/lecture/klass/' + id, {method: 'DELETE'});
}
